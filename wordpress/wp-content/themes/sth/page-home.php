                  ...
                  <div class="well">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <ul class="media-list" id="medical-imaging">

                            <li class="media">
                              <a href="#">
                                <div class="media-left">
                                    <img class="media-object" data-src="holder.js/64x64" alt="64x64" src="data:image/svg+xml;base64," data-holder-rendered="true" style="width: 64px; height: 64px;">
                                </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <ul class="media-list" id="medical-physics">
                            ...
                            <li class="media">
                              <a href="#">
                                ...
                                <div class="media-body">
                                  <h4 class="media-heading">Radiation Protection Assurance</h4>
                                  one-liner
                                </div>
                              </a>
                           </li>
                          ...
                          <li class="media">
                              <a href="#">
                                ...
                                <div class="media-body">
                                  <h4 class="media-heading">Stereotactic Surgery</h4>
                                  one-liner
                                </div>
                              </a>
                           </li>
